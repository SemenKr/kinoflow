...
const resources = {
  en: {
    translation: {
      ...
      movie_card_remove_favorites: 'Remove "{{title}}" from favorites',
      ...
      movie_details_trailer: 'Trailer',
      movie_details_trailer_play: 'Play trailer',
      ...
      person_details_movies_count_one: '{{count}} movie',
      person_details_movies_count_other: '{{count}} movies',
  ...
  ru: {
    translation: {
      ...
      movie_card_remove_favorites: 'Удалить "{{title}}" из избранного',
      ...
      movie_details_trailer: 'Трейлер',
      movie_details_trailer_play: 'Включить трейлер',
      ...
      person_details_movies_count_one: '{{count}} фильм',
      person_details_movies_count_few: '{{count}} фильма',
      person_details_movies_count_many: '{{count}} фильмов',
      person_details_movies_count_other: '{{count}} фильмов',
